...
df = pd.DataFrame(log)
df.to_csv("pendulum_inference_PPO_log.csv", index=False)
print("Inference log saved to pendulum_inference_PPO_log.csv\n")
...
plt.title("State Evolution - Pendulum-v1 using PPO")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("PPO-Pendulum-v1.png")
plt.show()
print("State plot saved to PPO-Pendulum-v1.png")
