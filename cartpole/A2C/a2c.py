...
print(f"\nStarting A2C training on {env_name} with RANDOMIZED INITIAL STATES...\n")
...
df = pd.DataFrame(log)
df.to_csv("cartpole_inference_A2C_log.csv", index=False)
print("Inference log saved to cartpole_inference_A2C_log.csv\n")
...
plt.title("State Evolution - CartPole-v1 using A2C")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("A2C-CartPole-v1.png")
plt.show()
print("State plot saved to A2C-CartPole-v1.png")
