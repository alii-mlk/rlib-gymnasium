...
print(f"\nStarting SAC training on {env_name} with RANDOMIZED INITIAL STATES...\n")
...
df = pd.DataFrame(log)
df.to_csv("cartpole_inference_SAC_log.csv", index=False)
print("Inference log saved to cartpole_inference_SAC_log.csv\n")
...
plt.title("State Evolution - CartPole-v1 using SAC")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("SAC-CartPole-v1.png")
plt.show()
print("State plot saved to SAC-CartPole-v1.png")
