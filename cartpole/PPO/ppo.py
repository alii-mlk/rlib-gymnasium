...
print(f"\nStarting PPO training on {env_name} with RANDOMIZED INITIAL STATES...\n")
...
df = pd.DataFrame(log)
df.to_csv("cartpole_inference_PPO_log.csv", index=False)
print("Inference log saved to cartpole_inference_PPO_log.csv\n")
...
plt.title("State Evolution - CartPole-v1 using PPO")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("PPO-CartPole-v1.png")
plt.show()
print("State plot saved to PPO-CartPole-v1.png")
