...
df = pd.DataFrame(log)
df.to_csv("mountaincarcontinuous_inference_PPO_log.csv", index=False)
print("Inference log saved to mountaincarcontinuous_inference_PPO_log.csv\n")
...
plt.title("State Evolution - MountainCarContinuous-v1 using PPO")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("PPO-MountainCarContinuous-v1.png")
plt.show()
print("State plot saved to PPO-MountainCarContinuous-v1.png")
