...
df = pd.DataFrame(log)
df.to_csv("mountaincarcontinuous_inference_SAC_log.csv", index=False)
print("Inference log saved to mountaincarcontinuous_inference_SAC_log.csv\n")
...
plt.title("State Evolution - MountainCarContinuous-v1 using SAC")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("SAC-MountainCarContinuous-v1.png")
plt.show()
print("State plot saved to SAC-MountainCarContinuous-v1.png")
