...
df = pd.DataFrame(log)
df.to_csv("mountaincar_inference_SAC_log.csv", index=False)
print("Inference log saved to sac_inference_log.csv\n")
...
plt.title("State Evolution - MountainCar-v1 using SAC")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("SAC-MountainCar-v1.png")
plt.show()
print("State plot saved to SAC-MountainCar-v1.png")
