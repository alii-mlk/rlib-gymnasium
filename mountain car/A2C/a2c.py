...
df = pd.DataFrame(log)
df.to_csv("a2c_inference_log.csv", index=False)
print("Inference log saved to a2c_inference_log.csv\n")
...
plt.title("State Evolution - MountainCar-v1 using A2C")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("A2C-MountainCar-v1.png")
plt.show()
print("State plot saved to A2C-MountainCar-v1.png")
