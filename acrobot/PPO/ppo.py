...
df = pd.DataFrame(log)
df.to_csv("acrobot_inference_PPO_log.csv", index=False)
print("Inference log saved to acrobot_inference_PPO_log.csv\n")
...
plt.title("State Evolution - Acrobot-v1 using PPO")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("PPO-Acrobot-v1.png")
plt.show()
print("State plot saved to PPO-Acrobot-v1.png")
