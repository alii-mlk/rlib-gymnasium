...
df = pd.DataFrame(log)
df.to_csv("acrobot_inference_SAC_log.csv", index=False)
print("Inference log saved to acrobot_inference_SAC_log.csv\n")
...
plt.title("State Evolution - Acrobot-v1 using SAC")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("SAC-Acrobot-v1.png")
plt.show()
print("State plot saved to SAC-Acrobot-v1.png")
