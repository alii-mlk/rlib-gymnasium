...
df = pd.DataFrame(log)
df.to_csv("acrobot_inference_A2C_log.csv", index=False)
print("Inference log saved to acrobot_inference_A2C_log.csv\n")
...
plt.title("State Evolution - Acrobot-v1 using A2C")
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("A2C-Acrobot-v1.png")
plt.show()
print("State plot saved to A2C-Acrobot-v1.png")
